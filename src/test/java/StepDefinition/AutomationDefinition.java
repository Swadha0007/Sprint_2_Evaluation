...
public class AutomationDefinition {
	...
	public void user_is_on_the_elearning_application_page() {
		...
		public void user_enters_the_login_credentials_like_and(String string, String string2) {
			...
			try {
				...
				System.out.println("able to enter the login credentials");
			} catch (Exception e) {
	...
	public void user_is_able_to_see_all_the_courses_in_user_portal() {
		...
		try {
			Thread.sleep(3000);
			String expectedtitle = "Most popular courses";
			String actualtitle = driver.findElement(By.xpath("(//*[@id=\"cm-content\"]/div/div[2]/div[1]/div/section/div[1]/h4)[1]")).getText();
			Assert.assertEquals(expectedtitle, actualtitle);
			System.out.println("The user is able to see all the most popular courses subscribed");
...
// These functions will only be specified when you are using the driver1 to subscribe the course
	  ...
	  public void user_is_on_the_elearning_page() { // Write code here that turns the phrase above into concrete actions 
	  ...
	  public void user_enters_the_login_credentials_which_are_and(String string,String string2) { // Write code here that turns the phrase above in concrete actions 
		  try 
		  { 
			  driver1.findElement(By.id("login")).sendKeys(string);
	          driver1.findElement(By.id("password")).sendKeys(string2);
	          System.out.println("You are able to enter the credentials");
		  } 
		  catch(Exception e) 
		  { System.out.println("Not Able to enter the login details "+e); }
	  ...
	  public void user_clicks_on_login_button() { // Write code here that turns the phrase above into concrete actions 
	  try {
	  ...
	  public void user_is_navigated_to_the_homepage() { // Write code here that turns the phrase above into concrete actions
	  ...
	  System.out.println("Not able to navigate to the home page"+e);
	  Assert.fail();
	  } }
	  
	  @Then("User clicks on course to be subscribed") 
	  public void user_clicks_on_course_to_be_subscribed() { // Write code here that turns the phrase above into concrete actions
	  try { 
		  driver1.findElement(By.xpath("(//*[@id=\"list-hot-courses\"]/div/div[2]/div/div[2]/div[3]/div[2]/div/a)[1]")).click();
	  System.out.println("Able to click on the subscription button"); }
	  catch(Exception e) {
	  ...
	  public void the_user_is_navigated_to_the_course_description_page_with_welcome_message() {
	  // Write code here that turns the phrase above into concrete actions 
		  try {
	  Thread.sleep(3000); 
	  String expectedtitle ="User Swadha Pankhudi (Swadha797) has been registered to course Selenium11";
	  String actualtitle =driver1.findElement(By.xpath("//*[@class='alert alert-info']")).getText();
	  Assert.assertEquals(expectedtitle,actualtitle);
	...
	public void user_is_able_to_see_the_forums_in_the_course() {
		...
		try {
			...
			String actualtitle = driver.findElement(By.xpath("(//*[@id=\"cm-content\"]/div/div[2]/div/div[2])[1]"))
					.getText();
			Assert.assertEquals(expectedtitle, actualtitle);
	...
	public void user_is_able_to_see_the_search_field_and_gives_the_values_such_as_for_groups_for_searching(
			String string) {
		// Write code here that turns the phrase above into concrete actions
	...
	public void user_can_see_the_documents_arranged_in_ascendiang_order_according_to_the_type_name_size_date() {
		...
		try {
			...
			System.out.println(
					"You are able  to see the type,name,size,date arranged in descending and ascending order ");
	...
	@Then("User gives the {string} for creating a new folder")
	public void user_gives_the_for_creating_a_new_folder(String string) {
	    // Write code here that turns the phrase above into concrete actions
		try {
			driver.findElement(By.id("add_new_category_category_name")).sendKeys(string);
